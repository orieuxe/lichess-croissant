...
assert.equal(await classifyCadence("1h30/40 - 30' + [30\"]", async () => "non-classique"), "classique");
assert.equal(await classifyCadence("25' + 10\"", async () => "classique"), "non-classique");
...
assert.equal(await classifyCadence("format bizarre", async () => "non-classique"), "classique");
